...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("45038264", "Erick", "Zuluaga", "erickaurazo@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("50150102", "Rolando", "Aurazo", "erick.aurazo@protonmail.com", "350 634 2747", "Calle Luna Calle Sol", "Customer");
